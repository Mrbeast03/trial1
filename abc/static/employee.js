...
function fetchPersonalDetails() {
    fetch("/get_employee_details")
        ...
        .then(data => {
            ...
            document.getElementById("displayPrimary").textContent = data.primary || "Not provided";
            document.getElementById("displayEmergency").textContent = data.emergency || "Not provided";
            document.getElementById("gender").textContent = data.employee.gender;
            
            document.getElementById("gender").value = data.employee.gender;
            // const displayGender = document.getElementById("displayGender");
            if (displayGender) {
                displayGender.textContent = data.gender || "Not provided";
            } else {
                console.warn("Element with ID displayGender not found");
            }

            // Set the dropdown value in the form (if present)
            ...
            //     } else {
            //         genderDropdown.value = ""; // Reset if invalid
            //     }
            // }
